...
var CostApplierService = /** @class */ (function () {
    function CostApplierService(databaseService, envConfig, signer, applyCosts, extractCostTime) {
        var _this = this;
        ...
        this.scanShortTermBalances = function () { return __awaiter(_this, void 0, void 0, function () {
            var batchVal, cursor, shortTermList, nftCosts, newCostList, i, nftCosts, result, i, nftCosts, resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, this.databaseService.setTrackerAndExtractBalance(nftCosts.nftID, nftCosts.costs)];
                    case 11:
                        resp = _a.sent();
                        if (!resp.success) {
        ...
        this.serverCostCalculator = new ethers_1.ethers.Contract(signer.address, ServerCostCalculator_1.default, signer);
