...
var BalanceRunMain = /** @class */ (function () {
    function BalanceRunMain(env, checkBalanceCondition, applyCosts, extractCostTime) {
        ...
        this.balanceSettleService = new balanceSettleService_1.default(this.envConfig, this.serverBalanceDatabaseService, this.signer, checkBalanceCondition);
        this.balanceExtractService = new balanceExtractService_1.default(this.envConfig);
