...
var balanceTrackerService_1 = __importDefault(require("./balanceTrackerService"));
...
var BalanceRunMain = /** @class */ (function () {
    function BalanceRunMain(env, checkBalanceCondition, applyCosts, extractCostTime) {
        var _this = this;
        ...
        this.addBalance = function (nftID, price) { return __awaiter(_this, void 0, void 0, function () {
            var trackerBalanceResp, extractBalanceResp, resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.serverBalanceDatabaseService.getTrackerBalance(nftID)];
                    case 1:
                        trackerBalanceResp = _a.sent();
                        if (!trackerBalanceResp.success) {
                            console.error("failed to get tracker balance: ", trackerBalanceResp.data);
                            return [2 /*return*/, trackerBalanceResp];
                        }
                        return [4 /*yield*/, this.serverBalanceDatabaseService.getExtractBalance(nftID)];
                    case 2:
                        extractBalanceResp = _a.sent();
                        if (!extractBalanceResp.success) {
                            console.error("failed to get extract balance: ", extractBalanceResp.data);
                            return [2 /*return*/, extractBalanceResp];
                        }
                        return [4 /*yield*/, this.serverBalanceDatabaseService.setTrackerAndExtractBalance(nftID, price)];
                    case 3:
                        resp = _a.sent();
        ...
        this.jsonProvider = new ethers_1.ethers.providers.JsonRpcProvider(this.envConfig.env.JSON_RPC_PROVIDER, undefined);
        ...
        this.balanceSettleService = new balanceTrackerService_1.default(this.envConfig, this.serverBalanceDatabaseService, this.signer, checkBalanceCondition);
        this.balanceExtractService = new balanceExtractService_1.default(this.envConfig, this.serverBalanceDatabaseService);
        this.costApplierService = new CostApplierService_1.default(this.serverBalanceDatabaseService, this.envConfig, this.signer, applyCosts, extractCostTime);
