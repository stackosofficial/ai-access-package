...
exports.validateServiceApiKey = exports.validateApiKey = void 0;
 ...
 */
const validateServiceApiKey = (apiKeyService, serviceId, serviceUrl) => {
    return async (req, res, next) => {
        try {
            const apiKey = req.headers['x-api-key'];
...
exports.validateServiceApiKey = validateServiceApiKey;
