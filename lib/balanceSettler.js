...
exports.scanNFTBalances = exports.addBalance = exports.setupDatabase = void 0;
...
var addCostToContract = function (skyNode, nftID, price) { return __awaiter(void 0, void 0, void 0, function () {
    var address, subnetID, abi, provider, wallet, serverCostCalculator, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var scanNFTBalances = function (skyNode) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 3:
                ...
                _a = true, cursor_1 = (e_1 = void 0, __asyncValues(cursor));
                _e.label = 4;
            case 4: return [4 /*yield*/, cursor_1.next()];
            case 5:
                if (!(cursor_1_1 = _e.sent(), _b = cursor_1_1.done, !_b)) return [3 /*break*/, 11];
                _d = cursor_1_1.value;
                _a = false;
                nftCosts = _d;
                if (!(nftCosts.costs !== '0')) return [3 /*break*/, 10];
                return [4 /*yield*/, addCostToContract(skyNode, nftCosts.nftID, nftCosts.costs)];
            case 6:
                resp = _e.sent();
                if (!resp.success) return [3 /*break*/, 8];
                return [4 /*yield*/, setBalance(nftCosts.nftID, '0')];
            case 7:
                _e.sent();
                _e.label = 8;
            case 8: return [4 /*yield*/, updateBalanceInContract(nftCosts.nftID)];
            case 9:
                _e.sent();
                _e.label = 10;
            case 10:
            ...
            case 19:
                ...
                return [3 /*break*/, 20];
            case 20: return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, NFT_UPDATE_INTERVAL); })];
            case 21:
                _e.sent();
                return [3 /*break*/, 0];
...
exports.scanNFTBalances = scanNFTBalances;
