...
var initializeSkyNodeCrypto = function (envConfig) { return __awaiter(void 0, void 0, void 0, function () {
    var skymainEnvConfig;
...
var getSkyNode = function (envConfig) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, initializeSkyNodeCrypto(envConfig)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var BalanceSettleService = /** @class */ (function () {
    function BalanceSettleService(envConfig, databaseService, signer, checkBalanceCondition) {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getSkyNode(this.envConfig)];
                    case 1:
                        skyNode = _a.sent();
                        SUBNET_ID = this.envConfig.env.SUBNET_ID;
                        ...
                        batchVal = 1000;
                        cursor = this.databaseService.getNFTExtractCursor(batchVal);
                        shortTermList = [];
                        _a.label = 2;
                    ...
                    case 11:
                        i++;
                        return [3 /*break*/, 7];
                    case 12: return [4 /*yield*/, this.databaseService.deleteNFTExtract(deleteList)];
                    case 13:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.serverCostCalculator = new ethers_1.ethers.Contract("0x099B69911207bE7a2A18C2a2878F9b267838e388", ServerCostCalculator_1.default, signer);
